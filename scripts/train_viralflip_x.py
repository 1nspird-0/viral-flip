...
# ViralFlip-X imports
from viralflip.model.viralflip_x import ViralFlipX
...
class ViralFlipXTrainer:
    ...
    def _validate(self, loader) -> dict:
        ...
        for batch in loader:
            ...
            with autocast(enabled=self.use_amp):
                predictions, _, _ = self.model(features, missing, quality, user_ids)
                predictions = predictions[:, -1, :]
    ...
    def _evaluate_conformal(self, loader) -> float:
        ...
        for batch in loader:
            ...
            predictions, _, _ = self.model(features, missing, quality)
...
def main():
    ...
    model = ViralFlipX(
        ...
        use_pretrained_encoder=model_cfg.get("use_pretrained_encoder", True),

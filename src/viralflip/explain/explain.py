...
class ExplanationEngine:
    ...
    def explain(
        ...
        with torch.no_grad():
            # Get prediction
            output = self.model.predict_single(
    ...
    def _compute_counterfactual(
        ...
        with torch.no_grad():
            original = self.model.predict_single(drift_dict, None, None, None)
            modified = self.model.predict_single(modified_dict, None, None, None)
